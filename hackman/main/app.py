...
class App():
    def __init__(self):
        ...
        self.model = load_model(os.path.join( "main", "chatbot_model.h5"))

        self.intents = json.loads(open("intents.json").read())
        self.words = p.load(open(os.path.join( "main", "words.pkl"), "rb"))
        self.tags = p.load(open(os.path.join( "main", "tags.pkl"), "rb"))
        ...
